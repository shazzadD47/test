...
from app.core.database.base import metadata
...
def include_object(object, name, type_, reflected, compare_to):
    """
    Exclude specific tables from auto-generation of migrations.
